...
map.on('load', function () {
    ...
    map.loadImage('markz.png', function(error, image){
        if(error) throw error;
        map.addImage('markz', image);
        ...
        "source": {
            "type": "geojson",
            "data": "https://api.myjson.com/bins/17ovgi"
        },
        "layout": {
            "icon-image": "markz",
            "icon-size": 0.4
...
var togglableLayerIds = ['Access', 'Easy', 'Medium', 'Hard', 'Advanced', 'Expert','Markers'];
